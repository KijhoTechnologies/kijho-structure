...
class ClienteRepository extends EntityRepository {
    ...
    public function getClientesByBarrio($barrio_id) {
        $dql = "SELECT c FROM Kijho\Seitem\BackendBundle\Entity\Cliente c "
                . "JOIN Kijho\Seitem\BackendBundle\Entity\Barrios b WITH bid=c.barrio "
    ...
    public function getClientesZona($zona_id) {
        $dql = "SELECT c, z "
                . "FROM Kijho\Seitem\BackendBundle\Entity\Cliente c "
