...
//    public static function getProductExistence(Producto $product, $em) {
    ...
    private function calculateProductExistence($prod_id) {
        $sql = 'SELECT inventario FROM Kijho\Seitem\BackendBundle\Entity\inventario_kardex WHERE cod_prod = ' . $prod_id;
    ...
    public function getProdSync($product_id) {
        ...
        $dql = 'SELECT p, c, b, rp FROM Kijho\Seitem\BackendBundle\Entity\Producto p JOIN p.category c JOIN p.baseProducts b JOIN b.rawProduct rp '
    ...
    public function getLastProductId() {
        $dql = 'SELECT MAX(pid) AS maxId FROM Kijho\Seitem\BackendBundle\Entity\Producto p';
//        return ('llega');
        $query = $this->getEntityManager()->createQuery($dql);
    ...
    public function getProdByCodeBarr($codeBarr, $codeProd) {
        $dql = "SELECT pid, p.name "
                . "FROM Kijho\Seitem\BackendBundle\Entity\Producto AS p WHERE "
    ...
    public function searchByCategory($catId) {
        $dql = "SELECT p.name, pid "
                . "FROM Kijho\Seitem\BackendBundle\Entity\Producto as p "
