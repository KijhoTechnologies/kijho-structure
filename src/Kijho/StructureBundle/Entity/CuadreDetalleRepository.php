...
class CuadreDetalleRepository extends EntityRepository {
    ...
    public function getKardex($fechaFin, $prodCodigo) {
        $dql = "SELECT dc.cuadetCodigo AS codigoRegistro, "
                ...
                . "FROM Kijho\Seitem\BackendBundle\Entity\CuadreDetalle dc "
                . "JOIN Kijho\Seitem\BackendBundle\Entity\Cuadre cua WITH dc.cuaCodigo = cua.cuaCodigo "
                . "JOIN Kijho\Seitem\BackendBundle\Entity\Cliente AS cli WITH cli.id = cua.cliCodigo "
