...
class BarriosRepository extends EntityRepository{
    public function getBarriosByMunicipio($mun_codigo){
        $dql = "SELECT b FROM Kijho\Seitem\BackendBundle\Entity\Barrios b JOIN b.munCodigo m LEFT JOIN b.zona z "
    ...
    public function getBarriosByZona($zona_id){
        $dql = "SELECT b FROM Kijho\Seitem\BackendBundle\Entity\Barrios b JOIN  Kijho\Seitem\BackendBundle\Entity\Municipios m WITH mid = b.munCodigo LEFT JOIN  Kijho\Seitem\BackendBundle\Entity\Zona z WITH zid = b.zona "
    ...
    public function getBarriosEditarZona ($zona_id, $mun_id){
        $dql = 'SELECT b, m FROM Kijho\Seitem\BackendBundle\Entity\Barrios b JOIN b.munCodigo m';
//        $dql = 'SELECT b, z FROM Kijho\Seitem\BackendBundle\Entity\Barrios b JOIN b.zona z ';
//                . 'WHERE b.zona IS NULL';
//                . "b.zona is NULL";
//                . "b.zona IS EMPTY";
//        $dql = "SELECT b, m, z FROM Kijho\Seitem\BackendBundle\Entity\Barrios b JOIN b.munCodigo m LEFT JOIN b.zona z "
...
//                . ' FROM Kijho\Seitem\BackendBundle\Entity\barrios b0_ '
