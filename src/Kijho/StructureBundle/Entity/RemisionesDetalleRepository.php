...
class RemisionesDetalleRepository extends EntityRepository {
    ...
    public function getKardex($fechaFin, $prodCodigo) {
        $dql = "SELECT rd.remdCodigo AS codigoRegistro, "
                ...
                . "JOIN  Kijho\Seitem\BackendBundle\Entity\Remisiones r WITH rd.remCodigo =  r.remCodigo "
                . "JOIN  Kijho\Seitem\BackendBundle\Entity\Cliente as cli WITH cliid = r.cliCodigo "
