...
class FacturasPorPagar {
     ...
     * @var string
     *
     * @ORM\Column(name="fpp_comentario", type="string", length=100, nullable=true)
     */
    private $fppComentario;
    ...
    function getFppComentario() {
        return $this->fppComentario;
    }

    function setFppComentario($fppComentario) {
        $this->fppComentario = $fppComentario;
    }
