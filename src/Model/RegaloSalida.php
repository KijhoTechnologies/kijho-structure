...
class RegaloSalida {
     ...
     *
     * @ORM\Column(name="resa_cod_barras", type="string", length=50, nullable=true)
     */
    private $resaCodBarras;
    ...
    function getResaCodBarras() {
        return $this->resaCodBarras;
    }

    function setResaCodBarras($resaCodBarras) {
        $this->resaCodBarras = $resaCodBarras;
    }
