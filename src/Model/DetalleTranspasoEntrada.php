...
class DetalleTranspasoEntrada {
     ...
     * @var string
     *
     * @ORM\Column(name="tran_cod_barras", type="string", length=50, nullable=true)
     */
    private $tranCodBarras;
    ...
    function getTranCodBarras() {
        return $this->tranCodBarras;
    }

    function setTranCodBarras($tranCodBarras) {
        $this->tranCodBarras = $tranCodBarras;
    }
