 ...
 * Salida
 *
 * @ORM\Entity(repositoryClass="SalidaRepository")
 * @ORM\Table(name="salida")
 */
class Salida {

    const SALIDA_DEVOLUCION_NO = 0;
    const SALIDA_DEVOLUCION_SI = 1;
     ...
     * @var integer
     *
     * @ORM\ManyToOne(targetEntity="FacturaVentas", inversedBy="items")
     ...
     * @return Salida
     */
    public function setFacvCodigo(FacturaVentas $facvCodigo) {
     ...
     * @return Salida
     */
    public function setProdCodigo(Producto $prodCodigo) {
    ...
    public function setDevolucionEstado($devolucionEstado) {
        $this->devolucionEstado = $devolucionEstado;
        return $this;
    }

    public function getDevolucionEstado() {
        return $this->devolucionEstado;
    }
