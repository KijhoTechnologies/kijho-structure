...
class PrestamoRepository extends EntityRepository {
    ...
    public function getKardex($fechaFin, $prodCodigo) {
        ...
        $dql = "SELECT pres.presCodigo AS codigoRegistro, "
                ...
                . "FROM KijhoStructureBundle:Prestamo pres, KijhoStructureBundle:PrestamosEntrada pe "
                . "WHERE "
                . "(pres.presTipo = 1 "
                . "OR pres.presTipo = 2) "
    ...
    public function getKardex2($fechaFin, $prodCodigo) {
        ...
        $dql = "SELECT pres.presCodigo AS codigoRegistro, "
                ...
                . "END) AS tipo, "
                . "pres.presHora AS horario "
                . "FROM KijhoStructureBundle:Prestamo pres, KijhoStructureBundle:PrestamosSalida ps "
                . "WHERE "
                . "(pres.presTipo = 1 "
                . "OR pres.presTipo = 2) "
                . "AND pres.presEstado = 1 "
