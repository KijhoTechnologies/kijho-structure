...
class Prestamo {
     ...
     *
     * @ORM\Column(name="pres_cod_barras", type="string", length=50, nullable=true)
     */
    private $presCodBarras;
    ...
    function getPresCodBarras() {
        return $this->presCodBarras;
    }

    function setPresCodBarras($presCodBarras) {
        $this->presCodBarras = $presCodBarras;
    }
