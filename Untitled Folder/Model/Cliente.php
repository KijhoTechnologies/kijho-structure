...
//    const CUSTOMER_QRCODE_ALREADY_ASSIGNED = 'CU-EQR-01';
    ...
    /**
     * @var string
     * @ORM\Column(type="string", name="cli_aplica_reteica", nullable=true, options={"default"="No"})
     */
    protected $reteica;

    /**
     * @var string
     * @ORM\Column(type="string", name="cli_aplica_retecree", nullable=true, options={"default"="No"})
     */
    protected $retecree;

    /**
     * @var string
     * @ORM\Column(type="string", name="cli_tipoPersona", nullable=true, length=50)
     */
    protected $tipoPersona;

    /**
     * @var string
     * @ORM\Column(type="string", name="cli_regimen_cliente", nullable=true, length=100)
     */
    protected $regimen;

    /**
     * @var string
     * @ORM\Column(type="string", name="cli_nombre_comercial", nullable=true, length=100)
     */
     ...
     * @ORM\JoinColumn(name="cli_zona_id", nullable=true)
     */
    protected $zona;
     ...
     * @var boolean
     * 
     * @ORM\Column(type="boolean", name="cli_borrado", nullable=true, options={"default"=FALSE})
     */
    private $deleted;
