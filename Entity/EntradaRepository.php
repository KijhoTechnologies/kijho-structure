...
class EntradaRepository extends EntityRepository {
    ...
    public function getKardex($fechaFin, $prodCodigo) {
        ...
        $dql = "SELECT "
                ...
                . "FROM KijhoStructureBundle:Entrada as ent "
                . "JOIN KijhoStructureBundle:FacturaProveedores AS fp WITH fp.facpCodigo = ent.facpCodigo "
                . "JOIN KijhoStructureBundle:Proveedor as pro WITH pro.provCodigo = fp.provCodigo "
                . "WHERE "
